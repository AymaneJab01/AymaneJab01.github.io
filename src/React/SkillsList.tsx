...
const CategoryIcons = {
  ...
  "Computer Architecture": (
    <svg
      ...
      className="w-6 h-6 text-[var(--sec)] opacity-70"
    >
      <path d="M9 3H15V5H17C18.1046 5 19 5.89543 19 7V9H21V15H19V17C19 18.1046 18.1046 19 17 19H15V21H9V19H7C5.89543 19 5 18.1046 5 17V15H3V9H5V7C5 5.89543 5.89543 5 7 5H9V3ZM7 7V17H17V7H7ZM9 9H15V15H9V9Z" />
    </svg>
  ),
  ...
  "Hardware & Software": (
    <svg
      ...
      className="w-6 h-6 text-[var(--sec)] opacity-70"
    >
      <path d="M4 4C2.89543 4 2 4.89543 2 6V16C2 17.1046 2.89543 18 4 18H11V20H8V22H16V20H13V18H20C21.1046 18 22 17.1046 22 16V6C22 4.89543 21.1046 4 20 4H4ZM4 6H20V16H4V6ZM6 8V14H18V8H6Z" />
    </svg>
  ),
};
...
type Skills = Record<Category, string[]>;
...
const SkillsList = () => {
  const [openItem, setOpenItem] = useState<Category | null>(null);
  ...
  return (
    <div className="text-left pt-3 md:pt-9">
      ...
      <ul className="space-y-4 mt-4 text-lg">
        {(Object.entries(skills) as [Category, string[]][]).map(
          ([category, items]) => (
